...
export const MEMBERS = {
  ...
  '17194932734': { name: 'Brittney Geister',  tab: 'Brittney Geister',  business: 'Closet Factory' },
  '17196198616': { name: 'Cindy Sabbogh',     tab: 'Cindy Sabbogh',     business: 'Best Option Restoration' },
  '17194280479': { name: 'Craig Kaltan',      tab: 'Craig Kaltan',      business: 'Olive Real Estate Group' },
  '18159008115': { name: 'Dan Trost',         tab: 'Dan Trost',         business: 'Oxi Fresh Carpet Cleaning' },
  ...
  '17193452535': { name: 'Rabbit Garduno',    tab: 'Rabbit Garduno',    business: 'Color2Color Painting' }, // same number as Jackson — WhatsApp name used as tiebreaker
