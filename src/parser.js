...
- "TYFCB" (Thank You For Closed Business) means exactly the same thing as "CB" — a closed_business object. It is often written lowercase and the amount often has NO dollar sign: "61.79 in tyfcb", "TYFCB 61.79", "TYFCB - $61.79" and "tyfcb: 61.79" all mean one closed_business object with amount 61.79. A bare decimal number sitting next to CB or TYFCB is a dollar amount even without a "$".
